# Cloud AI OCR — Tham khảo kỹ thuật trước 17/09/2026

Status: reference-only; không phải SOT nghiệp vụ hoặc xác nhận runtime hiện tại.
Nghiệp vụ phải sửa tại [spec.md](spec.md), theo [SPEC module](../../SPEC.md).
Nội dung dưới giữ để truy nguyên API/parser và các đề xuất cũ. Các câu
"đã chốt", "hiện tại" bên dưới nói về thời điểm tài liệu cũ; không ghi đè
cửa sổ OCR chỉ xem, Stage duyệt toàn cục hay gate phân loại của SPEC hiện hành.
Không đổi endpoint/công nghệ chỉ dựa vào tài liệu tham khảo này.

# Zalo Document Inbox — bản lưu tham khảo 08/2026

> **HISTORICAL / NON-NORMATIVE từ 17/09/2026. Không sửa nghiệp vụ tại đây.**
> Chương hiện hành là [spec.md](spec.md), thuộc [SPEC module](../../SPEC.md).
> Các nhãn APPROVED, SOT, “hiện tại” và yêu cầu bên dưới là bản ghi lịch sử,
> không còn cấp quyền triển khai. Đặc biệt R-028, US-003 và FR-009/010 về
> sửa/xác nhận ngay trong modal được thay bằng Stage và Cập nhật toàn cục.
> Khai tử để sau; ranh giới tài khoản là Zalo chung văn phòng theo B2, không
> phải tài khoản nhân viên. Giữ bản này để truy nguyên R/FR/SC và wire details,
> không dùng kế hoạch cũ để khôi phục hành vi đã bị thay thế.

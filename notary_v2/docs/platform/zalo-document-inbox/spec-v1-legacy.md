> **ARCHIVED — chỉ dùng đối chiếu runtime v1.** Yêu cầu hiện hành nằm tại [spec.md](spec.md). Những quy tắc chuyển ảnh/shared storage/manual history ở đây không áp dụng cho thiết kế mới.

# Feature specification: Zalo Document Inbox

> **Status lịch sử:** APPROVED v1; đã được thay thế về yêu cầu bởi spec.md ngày 24/09/2026
> **Owner/approver:** User

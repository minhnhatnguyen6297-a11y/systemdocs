...
Hook dang ky website portal gia lap (`fake_portal`, `fake_portal_b`) vao
provider registry cua engine upload_lab va ghi loopback URL ra file
G1_E2E_STATE de test doc duoc. KHONG sua sidecar/engine — chi them provider
fixture vao registry trong bo nho cua process test.
"""
...
def _install():
    ...
    for wid, rows in datasets.items():
        ...
        fixture.register_fake_portal_website(portal, website_id=wid)
